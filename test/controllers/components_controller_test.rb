...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference("Component.count") do
      post components_url, params: { component: { description: @component.description, name: @component.name, type: @component.type } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { description: @component.description, name: @component.name, type: @component.type } }
