class ComponentsController < ApplicationController
  ...
  def new
    ...
    @component.bike_order_items.build
  end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to components_path, status: :see_other, notice: "Component was successfully destroyed." }
  ...
  private
    ...
    def component_params
      params.require(:component).permit(:name, :description, :type)
    end
end
